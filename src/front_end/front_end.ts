...
function displayFinalOrder(commande: Order) {
  console.log(
    "Votre commande va prendre %d jours à être livré",
    commande.deliveryTime
  );
  ...
  console.log(
    "Le coût total de votre commande livrable est de %d euros",
    commande.totalPriceOrder
  );
}
